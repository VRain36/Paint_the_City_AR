    ...
    public class ArtImgManager : MonoBehaviour
    {
        ...
        public void LoadArtList(bool mode)
        {
            ...
            for (int i=0;i<indexArray.Count;i++)
            {
                ...
                RawImage artImg = child.transform.GetChild(0).gameObject.GetComponent<RawImage>(); 
                Text artName = child.transform.GetChild(1).gameObject.GetComponent<Text>();

                child.transform.GetChild(0).name = "ArtImage_RawImage " + childNum.ToString(); 
                child.transform.GetChild(1).name = "ArtName_Text (Legacy) " + childNum.ToString(); 
        ...
        public void ArtItemButtonClick() 
        {
            ...
            artItemNum = int.Parse(artItemName[artItemName.Length-1].ToString()); 
        }
